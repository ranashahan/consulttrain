...
CREATE TABLE `mastercategory` (
  ...
  KEY `mcsupercategory_fk_idx` (`supercategoryid`),
  ...
  CONSTRAINT `mcsupercategory_fk` FOREIGN KEY (`supercategoryid`) REFERENCES `supercategory` (`id`)
...
INSERT INTO `mastercategory` VALUES (1,'C&T Assessment','First assessment',1,1,1,1001,1001,'2024-10-03 16:50:05','2025-02-17 13:20:08'),(2,'Commentary Driving','Commentary Driving Description',1,2,1,1001,1001,'2024-10-03 19:43:48','2025-02-17 19:28:49'),(3,'swwd','sdfdd',NULL,NULL,0,1001,1001,'2024-11-01 05:38:38','2024-11-01 05:38:58'),(4,'sadf','asdf',NULL,NULL,0,1001,1001,'2024-11-01 05:40:40','2024-11-01 05:40:47'),(5,'General','This the general category',2,1,1,1001,1001,'2024-12-29 14:59:13','2025-02-17 13:20:37');
