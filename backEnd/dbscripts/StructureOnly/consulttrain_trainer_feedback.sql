...
CREATE TABLE `trainer_feedback` (
  ...
  CONSTRAINT `trainer_feedback_ibfk_1` FOREIGN KEY (`session_id`) REFERENCES `session` (`id`) ON DELETE CASCADE,
  CONSTRAINT `trainer_feedback_ibfk_2` FOREIGN KEY (`trainer_id`) REFERENCES `trainer` (`id`) ON DELETE CASCADE
