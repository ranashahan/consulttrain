...
BEGIN
    ...
    VALUES (d_Name, d_Gender, d_DOB, d_NIC, d_NICExpiry, d_LicenseNumber, d_LicenseTypeId, d_LicenseExpiry, d_LicenseVerified, d_Designation, d_Department, PermitNumber, PermitIssue, PermitExpiry, d_MedicalExpiry, d_BloodGroupId, d_ContractorId, d_VisualId, d_DDCCount, d_Experience, d_Code, d_Comment, d_CreatedBy, d_CreatedBy);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
