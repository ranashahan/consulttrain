...
INSERT INTO `vehicle` VALUES (10001,'LTV',1001,1001,'2024-09-16','2024-09-16');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `vehicle_BEFORE_INSERT` BEFORE INSERT ON `vehicle` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `vehicle_BEFORE_UPDATE` BEFORE UPDATE ON `vehicle` FOR EACH ROW BEGIN
