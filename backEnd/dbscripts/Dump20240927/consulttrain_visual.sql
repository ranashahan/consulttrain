...
INSERT INTO `visual` VALUES (11001,'Normal',1001,1001,'2024-09-16','2024-09-16');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `visual_BEFORE_INSERT` BEFORE INSERT ON `visual` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `visual_BEFORE_UPDATE` BEFORE UPDATE ON `visual` FOR EACH ROW BEGIN
