...
JOIN users u ON u.userid = d.modifiedby
...
t.commentry,
t.active,
p.username as createdby, t.created_at 
FROM training t 
join users p on p.userid = t.createdby
...
-- Dump completed on 2025-02-10  3:24:00
